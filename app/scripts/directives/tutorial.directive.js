      ...
      */
      scope.tutorialNext = function() {
        if (scope.tutorial.step < scope.tutorialSteps) {
          ...
          if (scope.tutorial.step === 0 || scope.tutorial.step === 4 || scope.tutorial.step === 5 || scope.tutorial.step === 8 || scope.tutorial.step === 11 || scope.tutorial.step === 14 || scope.tutorial.step === 17 || scope.tutorial.step === 20 || scope.tutorial.step === 21 || scope.tutorial.step === 24 || scope.tutorial.step === 27 || scope.tutorial.step === 30 || scope.tutorial.step === 34) {
